...
class EmailVerifyRequest {
  ...
  @override
  String toString() => 'EmailVerifyRequest[email=$email, code=$code]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EmailVerifyRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EmailVerifyRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
