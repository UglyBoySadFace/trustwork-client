...
class TokenResponse {
  ...
  @override
  String toString() => 'TokenResponse[accessToken=$accessToken, refreshToken=$refreshToken, tokenType=$tokenType, expiresIn=$expiresIn]';
  ...
  static TokenResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TokenResponse(
        ...
        expiresIn: mapValueOfType<int>(json, r'expires_in') ?? 900,
      );
    }
    return null;
  }
