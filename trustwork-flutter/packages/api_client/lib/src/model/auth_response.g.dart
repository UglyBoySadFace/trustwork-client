...
class _$AuthResponse extends AuthResponse {
  ...
  bool operator ==(Object other) {
    ...
    return other is AuthResponse &&
        ...
        matrixDeviceId == other.matrixDeviceId &&
        matrix == other.matrix &&
        user == other.user;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, matrixDeviceId.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'AuthResponse')
          ...
          ..add('matrixDeviceId', matrixDeviceId)
          ..add('matrix', matrix)
          ..add('user', user))
        .toString();
  }
...
class AuthResponseBuilder
  ...
  String? get matrixDeviceId => _$this._matrixDeviceId;
  set matrixDeviceId(String? matrixDeviceId) =>
      _$this._matrixDeviceId = matrixDeviceId;
  ...
  AuthResponseBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _matrixDeviceId = $v.matrixDeviceId;
