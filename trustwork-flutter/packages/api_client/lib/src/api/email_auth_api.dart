...
class EmailAuthApi {
  ...
  const EmailAuthApi(this._dio, this._serializers);
  ...
  Future<Response<AuthResponse>> emailLoginAuthEmailLoginPost({ 
    required EmailVerifyRequest emailVerifyRequest,
    ...
    final _path = r'/auth/email/login';
    ...
    try {
      const _type = FullType(EmailVerifyRequest);
      _bodyData = _serializers.serialize(emailVerifyRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmailStartResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmailStartResponse>> emailStartAuthEmailStartPost({ 
    required EmailStartRequest emailStartRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/email/start';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EmailStartRequest);
      _bodyData = _serializers.serialize(emailStartRequest, specifiedType: _type);
    ...
    EmailStartResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EmailStartResponse),
    ...
    return Response<EmailStartResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponse>> emailVerifyAuthEmailVerifyPost({ 
    required EmailVerifyRequest emailVerifyRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/auth/email/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> emailVerifyLinkAuthEmailVerifyLinkGet({ 
    ...
    final _path = r'/auth/email/verify-link';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
