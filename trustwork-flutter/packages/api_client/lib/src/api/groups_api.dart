...
class GroupsApi {
  ...
  Future<Response<GroupDetail>> addMemberGroupsGroupIdMembersPost({ 
    required int groupId,
    required MemberSuggestionCreate memberSuggestionCreate,
    ...
    final _path = r'/groups/{group_id}/members'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString());
    ...
    try {
      const _type = FullType(MemberSuggestionCreate);
      _bodyData = _serializers.serialize(memberSuggestionCreate, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [GroupDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GroupDetail>> createGroupGroupsPost({ 
    ...
    try {
      const _type = FullType(GroupCreate);
      _bodyData = _serializers.serialize(groupCreate, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> declineGroupGroupsGroupIdDeclinePost({ 
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> dismissSuggestionGroupsGroupIdSuggestionsSuggestionIdDismissPost({ 
    required int groupId,
    ...
    final _path = r'/groups/{group_id}/suggestions/{suggestion_id}/dismiss'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString()).replaceAll('{' r'suggestion_id' '}', encodeQueryParameter(_serializers, suggestionId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GroupDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GroupDetail>> getGroupGroupsGroupIdGet({ 
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GroupInvitePreview] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GroupInvitePreview>> invitePreviewGroupsGroupIdInvitePreviewGet({ 
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/groups/{group_id}/invite-preview'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GroupInvitePreview? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GroupInvitePreview),
      ) as GroupInvitePreview;
    ...
    return Response<GroupInvitePreview>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GroupDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GroupDetail>> inviteSuggestedGroupsGroupIdSuggestionsSuggestionIdInvitePost({ 
    required int groupId,
    required int suggestionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/groups/{group_id}/suggestions/{suggestion_id}/invite'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString()).replaceAll('{' r'suggestion_id' '}', encodeQueryParameter(_serializers, suggestionId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GroupDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GroupDetail>> joinGroupGroupsGroupIdJoinPost({ 
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/groups/{group_id}/join'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> leaveGroupGroupsGroupIdLeavePost({ 
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/groups/{group_id}/leave'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GroupSummary>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<GroupSummary>>> listGroupsGroupsGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<GroupSummary>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GroupSummary)]),
      ) as BuiltList<GroupSummary>;
    ...
    return Response<BuiltList<GroupSummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<MemberSuggestion>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<MemberSuggestion>>> listSuggestionsGroupsGroupIdSuggestionsGet({ 
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/groups/{group_id}/suggestions'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<MemberSuggestion>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(MemberSuggestion)]),
      ) as BuiltList<MemberSuggestion>;
    ...
    return Response<BuiltList<MemberSuggestion>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeMemberGroupsGroupIdMembersMatrixUserIdDelete({ 
    required int groupId,
    ...
    final _path = r'/groups/{group_id}/members/{matrix_user_id}'.replaceAll('{' r'group_id' '}', encodeQueryParameter(_serializers, groupId, const FullType(int)).toString()).replaceAll('{' r'matrix_user_id' '}', encodeQueryParameter(_serializers, matrixUserId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MemberSuggestion] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MemberSuggestion>> suggestMemberGroupsGroupIdSuggestionsPost({ 
    required int groupId,
    required MemberSuggestionCreate memberSuggestionCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    MemberSuggestion? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MemberSuggestion),
      ) as MemberSuggestion;
