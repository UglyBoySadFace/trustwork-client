...
class AuthApi {
  ...
  Future<Response<JsonObject>> bankidCallbackAuthBankidCallbackGet({ 
    String? code,
    String? state,
    String? error,
    ...
    final _path = r'/auth/bankid/callback';
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'error': encodeQueryParameter(_serializers, error, const FullType(String)),
      r'error_description': encodeQueryParameter(_serializers, errorDescription, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bankidStartAuthBankidStartGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/bankid/start';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bankidTestAuthBankidTestGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/bankid/test';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
