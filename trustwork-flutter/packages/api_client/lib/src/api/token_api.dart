...
class TokenApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [MatrixPasswordResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MatrixPasswordResponse>> getMatrixPasswordMeMatrixPasswordGet({ 
    ...
    final _path = r'/me/matrix-password';
    ...
    MatrixPasswordResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MatrixPasswordResponse),
      ) as MatrixPasswordResponse;
    ...
    return Response<MatrixPasswordResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfile>> getMeMeGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> refreshTokenAuthRefreshPost({ 
